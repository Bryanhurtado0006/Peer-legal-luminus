        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-gray-900">PEER-LEGAL</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm text-green-600 font-medium">Análisis completado</span>
          </div>
          <h2 className="text-4xl font-bold text-gray-900 mb-2">{mockData.caseTitle}</h2>
          <p className="text-gray-600">Tipo: {mockData.caseType} • Analizado con Gemini 1.5</p>
        </div>

        {/* 1. Resumen del Caso */}
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">📋 Resumen del Caso</h3>
          
          <div className="space-y-4">
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Partes Involucradas</h4>
              <p className="text-gray-700">{mockData.summary.parties}</p>
            </div>

            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Hechos Relevantes</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-900 mb-2">Conceptos Jurídicos Aplicables</h4>
        ...
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">🖼️ Análisis de Evidencia Visual</h3>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-4">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <p className="font-semibold text-gray-900">{mockData.visualAnalysis.filename}</p>
                <p className="text-sm text-gray-500">Analizado con Gemini 1.5 Vision</p>
              </div>
            </div>

            <h4 className="font-semibold text-gray-900 mb-2">Elementos Observados</h4>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
              <p className="text-sm text-blue-900"><strong>Relevancia Legal:</strong> {mockData.visualAnalysis.legalRelevance}</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">⚖️ Precedentes Jurídicos Relevantes</h3>
          
          <div className="space-y-4">
            {mockData.precedents.map((precedent) => (
              <div key={precedent.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between mb-2">
                  <h4 className="font-bold text-gray-900 flex-1">{precedent.name}</h4>
                  <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-semibold">
                    {precedent.similarity}% similar
                  </span>
                </div>
                {precedent.summary && (
                  <p className="text-gray-700 mb-2">{precedent.summary}</p>
                )}
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3">
                  <p className="text-sm text-yellow-900"><strong>Por qué es relevante:</strong> {precedent.relevance}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">💡 Estrategias Argumentales</h3>
          
          <div className="space-y-6">
            {mockData.strategies.map((strategy) => (
              <div key={strategy.id} className="border-2 border-gray-200 rounded-xl p-6">
                <div className="flex items-start justify-between mb-4">
                  <h4 className="text-xl font-bold text-gray-900">{strategy.title}</h4>
